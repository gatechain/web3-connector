...
class WalletConnect extends AbstractWallet {
  ...
  constructor({
    ...
    if (!isServer) {
      ...
      const {
        chains,
        optionalChains
      } = this.getChainProps(this.options.chains, this.options.optionalChains, this.defaultChainId);
      this.chains = chains;
  ...
  options = {
    ...
    optionalChains: [1, 10, 56, 86, 137, 195, 250, 324, 501, 4200, 8453, 42161, 43114, 59144, 81457],
    showQrModal: true,
    optionalMethods: ['eth_signTypedData', 'eth_signTypedData_v4', 'eth_sign'],
    qrModalOptions: {
      explorerRecommendedWalletIds: ['c57ca95b47569778a828d19178114f4db188b89b763c899ba0be274e97267d96', '1ae92b26df02f0abca6304df07debccd18262fdf5fe82daa81593582dac9a369', 'ef333840daf915aafdc4a004525502d6d49d77bd9c65e0642dbaefb3c2893bef', '20459438007b75f4f4acb98bf29aa3b800550309646d375da5fd4aac6c2a2c66'],
      themeVariables: {
        '--wcm-z-index': '10000'
      }
    }
  ...
  getChainProps(chains, optionalChains, desiredChainId = this.defaultChainId) {
    ...
    if (isArrayOneOrMore(orderedChains)) {
      return {
        ...
        optionalChains: orderedOptionalChains
      };
  ...
  static getInstance(showQrModal = true) {
    ...
    WalletConnect.instance = new WalletConnect({
      showQrModal
    });

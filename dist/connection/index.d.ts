...
export declare function getConnectionMap(metadata?: MetadataType): Connection[];
export declare function getConnection(c: Connector | ConnectionType, metadata?: MetadataType): Connection;
...
export declare function connectWallet(connectionType: ConnectionType, resolve?: (uri: string) => void, reject?: (err: any) => void, metadata?: MetadataType): void;

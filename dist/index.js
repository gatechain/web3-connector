...
var ethProviderModule = require('@walletconnect/ethereum-provider');
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                updateStore({
                    ...
                    gateAccountInfo,
                    connector: this,
                    currentWallet: exports.ConnectionType.GATEWALLET,
                });
            }
            catch (error) {
                console.error(error);
            ...
            return Promise.all([
                ...
                if (!desiredChainId || receivedChainId === desiredChainId) {
                    updateStore({
                        ...
                        currentWallet: exports.ConnectionType.INJECTED,
                        connector: this,
                    });
                    return;
                }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                updateStore({
                    isActive: true,
                    gateAccountInfo,
                    currentWallet: exports.ConnectionType.PHANTOM,
                    connector: this,
                });
            }
            catch (error) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                updateStore({
                    isActive: true,
                    connector: this,
                    currentWallet: exports.ConnectionType.Unisat,
                    account: accounts[0],
                    accounts: accounts,
                    network: network,
                });
    ...
    connectEagerly() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            updateStore({
                ...
                connector: this,
                currentWallet: exports.ConnectionType.WALLET_CONNECT,
            });
        });
    }
...
function connectWallet(connectionType, resolve, reject) {
    ...
    if (connectionType !== exports.ConnectionType.WALLET_CONNECT_NOTQR) {
...
function getConnector(connectionType, resolve) {
    const map = {
        [exports.ConnectionType.GATEWALLET]: GateWallet,
        [exports.ConnectionType.INJECTED]: MetaMaskWallet,
        [exports.ConnectionType.PHANTOM]: PhantomWallet,
        [exports.ConnectionType.Unisat]: UnisatWallet,
        [exports.ConnectionType.WALLET_CONNECT_NOTQR]: WalletConnectNoQr,
        [exports.ConnectionType.WALLET_CONNECT]: WalletConnect,
    };
    if (connectionType === exports.ConnectionType.WALLET_CONNECT_NOTQR) {
